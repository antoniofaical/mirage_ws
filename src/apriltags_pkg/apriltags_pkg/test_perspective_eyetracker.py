...
class DynamicFrameBroadcaster(Node):
    ...
    def broadcast_timer_callback(self):
        ...
        #Parâmetros para o 3D:
            ...
            gaze_homo=np.array([x_gaze,y_gaze])
            ...
            if ids_TAG36H11 is not None:
                ...
                for i in range(len(ids_TAG36H11)):
                        ...
                        #CALCULO DO PONTO
                            ...
                            p2=np.array([[self.CENTER_X_36H11_0+(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_0+(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_0-(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_0+(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_0-(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_0-(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_0+(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_0-(self.SIZE_APRILTAG36H11_INTERFACE/2)]],dtype=np.float32)
                        ...
                        #CALCULO DO PONTO
                            ...
                            p2=np.array([[self.CENTER_X_36H11_1+(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_1+(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_1-(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_1+(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_1-(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_1-(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_1+(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_1-(self.SIZE_APRILTAG36H11_INTERFACE/2)]],dtype=np.float32)
                        ...
                        #CALCULO DO PONTO
                            ...
                            p2=np.array([[self.CENTER_X_36H11_2+(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_2+(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_2-(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_2+(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_2-(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_2-(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_2+(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_2-(self.SIZE_APRILTAG36H11_INTERFACE/2)]],dtype=np.float32)
                        ...
                        #CALCULO DO PONTO
                            ...
                            p2=np.array([[self.CENTER_X_36H11_3+(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_3+(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_3-(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_3+(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_3-(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_3-(self.SIZE_APRILTAG36H11_INTERFACE/2)],
                                        [self.CENTER_X_36H11_3+(self.SIZE_APRILTAG36H11_INTERFACE/2),self.CENTER_Y_36H11_3-(self.SIZE_APRILTAG36H11_INTERFACE/2)]],dtype=np.float32)
        ...
        ############################################################################
                ...
                # Definição do ponto e homografia
                corners_g=np.delete(corners_g,0,axis=0)
                points=np.delete(points,0,axis=0)    
                T,_= cv2.findHomography(corners_g, points) #method=cv2.RANSAC cv2.BORDER_CONSTANT
                print(T)
                #T,_= cv2.estimateAffine2D(corners_g, points) 
                gaze_homo_point=np.array([[gaze_homo]],np.float32)
                transformed_gaze= cv2.perspectiveTransform(gaze_homo_point, T)
                gaze_homo_x,gaze_homo_y=transformed_gaze[0][0]


                imgtrans=cv2.warpPerspective(imgtrans,T,(self.interface_width,self.interface_height))
                cv2.circle(imgtrans, (int(gaze_homo_x),int(gaze_homo_y)), 5, (0, 0, 255), -1)

                #med_point_x=gaze_homo_x
                #med_point_y=gaze_homo_y

                self.apriltag_buffer_x.append(gaze_homo_x)
                self.apriltag_buffer_y.append(gaze_homo_y)
            ...
            # Using resizeWindow() 
            cv2.resizeWindow("Homography", self.interface_width, self.interface_height)  
            cv2.imshow("Webcam",undistorted_frame)
            cv2.imshow("Homography",imgtrans)
    ...
    def interface_variables(self):
        ...
        self.CENTER_X_36H11_0=((self.distance_proportion*self.interface_width)+self.SIZE_APRILTAG36H11_INTERFACE/2) #DISTANCEPROPORTION*interface_width+SIZE_APRILTAG36H11_INTERFACE/2
        self.CENTER_Y_36H11_0=((self.distance_proportion*self.interface_height)+self.SIZE_APRILTAG36H11_INTERFACE/2)  #DISTANCEPROPORTION*interface_height+SIZE_APRILTAG36H11_INTERFACE/2
        self.CENTER_X_36H11_1=((self.distance_proportion*self.interface_width)+self.SIZE_APRILTAG36H11_INTERFACE/2) #DISTANCEPROPORTION*interface_width+SIZE_APRILTAG36H11_INTERFACE/2
        self.CENTER_Y_36H11_1=(self.interface_height-(self.distance_proportion*self.interface_height)-self.SIZE_APRILTAG36H11_INTERFACE/2) #DISTANCEPROPORTION*interface_height+SIZE_APRILTAG36H11_INTERFACE/2
        self.CENTER_X_36H11_2=(self.interface_width-(self.distance_proportion*self.interface_width)-self.SIZE_APRILTAG36H11_INTERFACE/2) #
        self.CENTER_Y_36H11_2=(self.interface_height-(self.distance_proportion*self.interface_height)-self.SIZE_APRILTAG36H11_INTERFACE/2) #
        self.CENTER_X_36H11_3=(self.interface_width-(self.distance_proportion*self.interface_width)-self.SIZE_APRILTAG36H11_INTERFACE/2) #
        self.CENTER_Y_36H11_3=((self.distance_proportion*self.interface_height)+self.SIZE_APRILTAG36H11_INTERFACE/2) #

    def homography_parameters(self):
         None
