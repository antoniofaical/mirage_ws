...
CENTER_Y_36H11_0=90
CENTER_X_36H11_1=98
CENTER_Y_36H11_1=510
CENTER_X_36H11_2=1102
CENTER_Y_36H11_2=510
CENTER_X_36H11_3=1102
CENTER_Y_36H11_3=90
CENTER_X_16H5=53
CENTER_Y_16H5=54
            ...
            if ids_TAG36H11 is not None:
                ...
                for i in range(len(ids_TAG36H11)):
                        ...
                        #CALCULO DO PONTO
                            ...
                            Con_x=int(abs((196*(center_x_TAG36H11-center_x_TAG16H5))/(width)))
                            Con_y=int(abs((179*(center_y_TAG36H11-center_y_TAG16H5))/(height)))
                            #Circulo
                            P_x=CENTER_X_36H11_0+Con_x
                            P_y=CENTER_Y_36H11_0+Con_y

                            #cv2.circle(undistorted_frame, (P_x,P_y), radius=10, color=(0, 255, 255), thickness=0)
                        ...
                        #CALCULO DO PONTO
                            ...
                            Con_y=int(abs((179*(center_y_TAG36H11-center_y_TAG16H5))/(height)))
                            #Circulo
                            P_x=CENTER_X_36H11_1+Con_x
                            P_y=CENTER_Y_36H11_1-Con_y
                        ...
                        #CALCULO DO PONTO
                            ...
                            Con_y=int(abs((179*(center_y_TAG36H11-center_y_TAG16H5))/(height)))
                            #Circulo
                            P_x=CENTER_X_36H11_2-Con_x
                            P_y=CENTER_Y_36H11_2-Con_y
                            #cv2.circle(undistorted_frame, (P_x,P_y), radius=10, color=(0, 255, 255), thickness=0)
                        ...
                        #CALCULO DO PONTO
                            ...
                            Con_y=int(abs((179*(center_y_TAG36H11-center_y_TAG16H5))/(height)))
                            #Circulo
                            P_x=CENTER_X_36H11_3-Con_x
                            P_y=CENTER_Y_36H11_3+Con_y
...
############################PLOT FRAME###############################################
            #7° Parte: Enviando as transformadas
                ...
                med_point_x=int(np.mean(array_point_x))
                med_point_y=int(np.mean(array_point_y))

                if ids_TAH16H5 is None:
                     med_point_x=0.0
                     med_point_y=0.0
